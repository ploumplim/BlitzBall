    ...
    SubShader
    {
       ...
       LOD 100
        ...
        Pass
        {
            ...
            float4 Unity_Universal_SampleBuffer_BlitSource_float5( float2 uv )
            {
            ...
            half4 frag (v2f i ) : SV_Target
            {
				...
				float4 localUnity_Universal_SampleBuffer_BlitSource_float5 = Unity_Universal_SampleBuffer_BlitSource_float5( uv5 );
				

                
                float4 color = ( localUnity_Universal_SampleBuffer_BlitSource_float5 + 0.2 );
                return color;
            }
            ENDHLSL
        }
