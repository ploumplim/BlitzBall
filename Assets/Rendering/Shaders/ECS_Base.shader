...
Shader "BlitzBall/ECS_Base"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 CalculateShadowMask1_g62352( half2 LightmapUV )
			{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord220 = input.ase_texcoord5.xy * temp_cast_0 + float2( 0,0 );
				float3 unpack224 = UnpackNormalScale( tex2D( _NormalMap, texCoord220 ), _NormalScale );
				unpack224.z = lerp( 1, unpack224.z, saturate(_NormalScale) );
				...
				float3 tanNormal18_g62349 = unpack224;
				float3 worldNormal18_g62349 = float3( dot( tanToWorld0, tanNormal18_g62349 ), dot( tanToWorld1, tanNormal18_g62349 ), dot( tanToWorld2, tanNormal18_g62349 ) );
				float3 worldNormal19_g62349 = worldNormal18_g62349;
				float dotResult102_g62349 = dot( worldNormal19_g62349 , WorldViewDirection );
				float specSmoothness95_g62349 = ( 1.0 - _SpecularCoverage );
				float dotResult1_g62349 = dot( worldNormal19_g62349 , _MainLightPosition.xyz );
				float mainLightFall156_g62349 = dotResult1_g62349;
				float temp_output_178_0_g62349 = ( ( dotResult102_g62349 * ( 1.0 - specSmoothness95_g62349 ) ) * mainLightFall156_g62349 );
				float3 WorldPosition288_g62354 = WorldPosition;
				float3 WorldPosition327_g62354 = WorldPosition288_g62354;
				float2 ScreenUV286_g62354 = (ScreenPosNorm).xy;
				float2 ScreenUV327_g62354 = ScreenUV286_g62354;
				float3 WorldNormal281_g62354 = worldNormal19_g62349;
				float3 WorldNormal327_g62354 = WorldNormal281_g62354;
				float3 WorldView327_g62354 = WorldViewDirection;
				float3 temp_cast_1 = (1.0).xxx;
				float3 SpecColor327_g62354 = temp_cast_1;
				float Smoothness327_g62354 = specSmoothness95_g62349;
				half2 LightmapUV1_g62352 = (input.ase_texcoord5.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				half4 localCalculateShadowMask1_g62352 = CalculateShadowMask1_g62352( LightmapUV1_g62352 );
				float4 shadowMask83_g62349 = localCalculateShadowMask1_g62352;
				float4 ShadowMask360_g62354 = shadowMask83_g62349;
				float4 ShadowMask327_g62354 = ShadowMask360_g62354;
				float3 localAdditionalLightsSpecularMask170x327_g62354 = AdditionalLightsSpecularMask170x( WorldPosition327_g62354 , ScreenUV327_g62354 , WorldNormal327_g62354 , WorldView327_g62354 , SpecColor327_g62354 , Smoothness327_g62354 , ShadowMask327_g62354 );
				float3 temp_output_56_0_g62349 = localAdditionalLightsSpecularMask170x327_g62354;
				float2 temp_cast_2 = (( temp_output_178_0_g62349 + length( temp_output_56_0_g62349 ) )).xx;
				float4 tex2DNode26_g62349 = tex2D( _LightRamp, temp_cast_2 );
				float Specular46_g62349 = ( tex2DNode26_g62349.r * _SpecularForce );
				float3 WorldPosition50_g62349 = WorldPosition;
				float2 temp_output_4_0_g62349 = (ScreenPosNorm).xy;
				float2 ScreenUV50_g62349 = temp_output_4_0_g62349;
				float3 WorldNormal50_g62349 = worldNormal19_g62349;
				float4 ShadowMask50_g62349 = shadowMask83_g62349;
				sampler2D Ramp50_g62349 = _LightRamp;
				float distOffset50_g62349 = 0.49;
				float nDotSum50_g62349 = 0.0;
				float3 localAdditionalLightsClassicCompute50_g62349 = AdditionalLightsClassicCompute( WorldPosition50_g62349 , ScreenUV50_g62349 , WorldNormal50_g62349 , ShadowMask50_g62349 , Ramp50_g62349 , distOffset50_g62349 , nDotSum50_g62349 );
				float3 AddPass48_g62349 = localAdditionalLightsClassicCompute50_g62349;
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b ) + 1e-7;
				float4 ase_lightColor = float4( _MainLightColor.rgb / ase_lightIntensity, ase_lightIntensity );
				float3 MainLightCol123_g62349 = ase_lightColor.rgb;
				float ase_lightAtten = 0;
				Light ase_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_mainLight.distanceAttenuation * ase_mainLight.shadowAttenuation;
				float2 temp_cast_3 = (( step( 0.85 , ase_lightAtten ) * dotResult1_g62349 )).xx;
				float4 tex2DNode9_g62349 = tex2D( _LightRamp, temp_cast_3 );
				float3 BasePass80_g62349 = ( ( MainLightCol123_g62349 * tex2DNode9_g62349.r ) * ase_lightColor.a );
				float3 temp_output_12_0_g62349 = ( AddPass48_g62349 + BasePass80_g62349 );
				float3 Lights107_g62349 = temp_output_12_0_g62349;
				float ViewReflect205_g62349 = dotResult102_g62349;
				float smoothstepResult128_g62349 = smoothstep( 0.6 , 0.8 , ( saturate( pow( ( 1.0 - ViewReflect205_g62349 ) , _RimPower ) ) * saturate( length( Lights107_g62349 ) ) ));
				float3 Rim112_g62349 = ( max( smoothstepResult128_g62349 , 0.0 ) * ( (_RimColor).rgb * Lights107_g62349 ) );
				float3 bakedGI36_g62349 = ASEIndirectDiffuse( input, worldNormal19_g62349, WorldPosition, WorldViewDirection );
				MixRealtimeAndBakedGI( ase_mainLight, worldNormal19_g62349, bakedGI36_g62349, half4( 0, 0, 0, 0 ) );
				float3 albedo91_g62349 = ( tex2D( _AlbedoMap, texCoord220 ).rgb * _Tint );
				float3 temp_output_221_0 = ( ( Specular46_g62349 * min( length( Lights107_g62349 ) , 1.0 ) ) + ( ( Rim112_g62349 + ( temp_output_12_0_g62349 + bakedGI36_g62349 ) ) * albedo91_g62349 ) );
				#ifdef _HADESMODE_ON
				float3 staticSwitch109 = ( temp_output_221_0 * step( _HadesForce , tex2D( _HadesMap, texCoord220 ).r ) );
				#else
				float3 staticSwitch109 = temp_output_221_0;
				#endif
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;108;304,384;Inherit;False;Property;_HadesForce;HadesForce;17;0;Create;True;0;0;0;False;0;False;0;0.576;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;131;336,16;Inherit;False;Property;_RimColor;Rim Color;12;1;[HDR];Create;True;0;0;0;False;0;False;4,4,4,0;4,4,4,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;115;400,208;Inherit;False;Property;_RimPower;Rim Power;13;0;Create;True;0;0;0;False;0;False;0.47;0.58;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;178;80,208;Inherit;False;Property;_SpecularForce;Specular Force;11;0;Create;True;0;0;0;False;0;False;1.5;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;95;-288,144;Inherit;False;Property;_SpecularCoverage;Specular Coverage;10;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;14;-256,48;Inherit;False;Property;_NormalScale;Normal Scale;7;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;92;-256,-320;Inherit;True;Property;_AlbedoMap;Albedo Map;5;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;217;-48,-208;Inherit;False;Property;_Tint;Tint;15;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;False;0;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;221;704,-192;Inherit;True;ExperimentalCelShading;0;;62349;51a58a171e7e5ac4cabf76a8bb546441;6,171,1,51,0,151,0,40,0,147,1,66,0;9;34;SAMPLER2D;;False;89;FLOAT3;0,0,0;False;37;FLOAT3;0,0,0;False;94;FLOAT;1;False;172;FLOAT;0;False;144;COLOR;0,0,0,0;False;105;FLOAT;0;False;58;FLOAT;1;False;195;FLOAT;0;False;2;FLOAT3;0;FLOAT;167
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;17;-64,-96;Inherit;True;Property;_NormalMap;Normal Map;6;3;[NoScaleOffset];[Normal];[SingleLineTexture];Create;True;0;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;224;208,-144;Inherit;True;Property;_TextureSample0;Texture Sample 0;16;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
WireConnection;109;1;221;0
WireConnection;109;0;107;0
WireConnection;216;0;92;5
WireConnection;216;1;217;0
WireConnection;221;34;13;0
WireConnection;221;89;216;0
WireConnection;221;37;224;0
WireConnection;221;94;100;0
WireConnection;221;172;178;0
WireConnection;221;144;131;0
WireConnection;221;105;115;0
WireConnection;221;58;139;0
WireConnection;220;0;223;0
WireConnection;224;0;17;0
WireConnection;224;1;220;0
WireConnection;224;5;14;0
WireConnection;1;2;109;0
ASEEND*/
//CHKSM=BD1B71F51C5361FF44EADCB56320E30E800D1B81